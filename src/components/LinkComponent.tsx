...
const LinkComponent = ({ url, imgURL, text }: LinkComponentProps) => {
  return (
    <Link
      href={url}
      className="p-2 rounded-sm bg-brand-purple/20 grid grid-cols-[auto_1fr_auto] place-items-center group hover:scale-[1.001] transition-transform duration-150 ease-in-out"
    >
      <div>
